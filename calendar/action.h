 ...
 *
 * Header contenant toute les fonctions de bases pour la structure action
 ...
 * \def listAction_t
 *
 * Simplification, une liste d'action est en réalité un pointeur vers l'action
 ...
 * \brief Vérifie si le jour est cohérent (entre 1 et 7)
 * \param jour : le jour à vérifié
 ...
 * \brief Vérifie si l'heure est cohérent (entre 00 et 24)
 * \param jour : l'heure à vérifié
 * \return 1 si cohérent, 0 sinon
 *
 **/
 ...
 * \return L'action remplie avec les arguments données si ils sont correctes,
 * NULL sinon
 *
 **/
 ...
 * \param listAct : la liste a libéré
 * \return void
 *
 **/
 ...
 * \brief recherche l'adresse de l'action avec l'heure et le jour donnait en
 arguement
 * \param heure : l'heure (00 à 24),
 * \param jour : le jour (1 à 7),
 * \param listAct : la liste où il faut chercher
 * \return un pointeur de pointeur vers la cellule précédent celle recherché où
 * la première plus grande, NUll si heure et jour ne sont pas correcte
 *
 **/
 ...
 * \brief supprime l'action du jour et heure indiqué dans la liste listAct
 * \param jour : le jour de l'action à supprimer (0 à 7)
 * \param heure : l'heure de l'action à supprimer (0 à 24)
 * \param listAct : la liste d'action ou il faut supprimer
 * \return void
 *
